import {
  ...
  const Books = () => {
    ...
    useEffect(() => {
      const results = fetchCats(`http://localhost:3000/api/agg/${selectedOption2}`).then(
       (res)=>{
        setFilterdBooks(res);
    ...
    useEffect(() => {
      const results = fetchCats(`http://localhost:3000/api/books`).then(
       (res)=>{
        setFilterdBooks(res);
    ...
    useEffect(() => {
      const results = fetchCats(`http://localhost:3000/api/category/${selectedOption}`).then(
       (res)=>{
    ...
    useEffect(() => {
      const results = fetchCats(`http://localhost:3000/api/cats`).then(
       (res)=>{
        setOptions(res);
        // console.log(res)
       }
